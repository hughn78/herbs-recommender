  ...
  return (
    <div className="px-8 py-10 max-w-5xl mx-auto">
      <div className="flex items-end justify-between">
        ...
        <Link
          to="/app/review"
          className="inline-flex items-center gap-2 rounded-lg bg-amber text-amber-foreground px-4 py-2.5 text-sm font-medium hover:bg-amber/85"
        >
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link to="/app/review" className="pp-glass p-5 hover:bg-secondary/40 transition-colors">
        ...
        <Link to="/app/cases" className="pp-glass p-5 hover:bg-secondary/40 transition-colors">
        ...
        <Link to="/app/rules" className="pp-glass p-5 hover:bg-secondary/40 transition-colors">
